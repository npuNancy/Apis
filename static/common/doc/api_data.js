define({ "api": [
  ...
  {
    "type": "post",
    "url": "/specificApis/admin/gradeAdminAdd",
    "title": "gradeAdminAdd",
    "version": "1.0.0",
    ...
    "sampleRequest": [
      {
        "url": window.location.origin + "/api/specificApis/admin/gradeAdminAdd"
      }
    ]
  },
  {
    "type": "post",
    "url": "/specificApis/admin/gradeAdminDelete",
    ...
    "sampleRequest": [
      {
        "url": window.location.origin + "/api/specificApis/admin/gradeAdminDelete"
      }
    ]
  },
  {
    "type": "get",
    "url": "/specificApis/admin/gradeAdminGetAll",
    ...
    "sampleRequest": [
      {
        "url": window.location.origin + "/api/specificApis/admin/gradeAdminGetAll"
      }
    ]
  },
  {
    "type": "get",
    "url": "/specificApis/admin/gradeAdminLogout",
    ...
    "sampleRequest": [
      {
        "url": window.location.origin + "/api/specificApis/admin/gradeAdminLogout"
      }
    ]
  },
  {
