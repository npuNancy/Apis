$(document).ready(function() {
    $(this).ajaxSubmit({
        url: "/api/specificApis/studentData/getClassStudents",
        type: "GET",
...
var getState = function(studentId) {
    var ret;
    $(document).ajaxSubmit({
        url: "/api/specificApis/studentData/getStudentstates",
        type: "POST",
        async: false,
        data: {
            'studentId': studentId
...
var askLeave = function() {
    $(".btn-askLeave").click(function() {
        ...
        $(this).ajaxSubmit({
            url: "/api/specificApis/studentData/askLeave",
            type: "POST",
            data: {
                "studentId": studentId
            },
...
var signIn = function() {
    $(".btn-Start").click(function() {
        ...
        var studentId = tr.attr('data-studentId');
        $(this).ajaxSubmit({
            url: "/api/specificApis/studentData/signIn",
            type: "POST",
            data: {
                "studentId": studentId
            },
...
var signOut = function() {
    $('.btn-End').click(function() {
        ...
        $(this).ajaxSubmit({
            url: "/api/specificApis/studentData/signOut",
            type: "POST",
            data: {
                "studentId": studentId,
                "dataId": dataId
